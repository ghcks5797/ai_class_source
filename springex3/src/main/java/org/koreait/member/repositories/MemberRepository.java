...
public interface MemberRepository extends ListCrudRepository<Member, Long> {
    ...
    List<Member> findByRegDtBetweenOrderByRegDtDesc(LocalDateTime sdate, LocalDateTime eDate);List<Member> findByRegDtBetweenAndNameContainingOrderByRegDtDesc(LocalDateTime sdate, LocalDateTime eDatem, String keyword);
